...
geo_busan=json.load(open('C:/Users/win/Desktop/data/sigoo.geojson',encoding='UTF-8'))
feature=[x for x in geo_busan['features'] if x['properties']['SIG_CD'].startswith('26')]
geo_busan['features']=feature


df_pop=pd.read_csv('C:/Users/win/Desktop/data/Population_SIG.csv')
df_pop.info()
...
pusan_pop=pd.read_csv('C:/Users/win/Desktop/data/pusan_pop(1).csv',encoding='euc-kr')
